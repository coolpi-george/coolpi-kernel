...
#define JADARD_DRIVER_VER        "01.C9" /* MAJOR_VER.MINOR_VER */
#define JADARD_DRIVER_CID_VER    "01.01" /* MAJOR_CID_VER.MINOR_CID_VER */
...
#define JD_GEST_SUP_NUM           (23)
    ...
    #define JD_TOUCH_STATE_ALL_SIZE   (JD_TOUCH_STATE_INFO_SIZE + 6)
...
#else
#define JD_UPGRADE_DELAY_TIME    (1500)
#endif
